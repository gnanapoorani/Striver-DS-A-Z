...
public class LoadBalancerTaskNew implements Runnable {

    final SortedMap<Integer, String> bucketIdToServer;
    final ConsistentHashing.HashFunction hashFunction;

    public LoadBalancerTaskNew(final SortedMap<Integer, String> bucketIdToServer, final ConsistentHashing.HashFunction hashFunction) {
