...
BFS - we should use queue,DFS means either do it recursively or if iterative method- use stack.
- [Pre post inorder ](https://leetcode.com/problems/binary-tree-postorder-traversal/solutions/45551/preorder-inorder-and-postorder-iteratively-summarization/)
